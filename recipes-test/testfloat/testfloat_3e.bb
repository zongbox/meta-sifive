...
do_install(){
    ...
    install ${S}/TestFloat-${PV}/build/Linux-Cross-Compile/testfloat     ${D}/${TARGET_TEST_DIR}
    install ${S}/TestFloat-${PV}/build/Linux-Cross-Compile/testfloat_gen ${D}/${TARGET_TEST_DIR}
    install ${S}/TestFloat-${PV}/build/Linux-Cross-Compile/testfloat_ver ${D}/${TARGET_TEST_DIR}
    install ${S}/TestFloat-${PV}/build/Linux-Cross-Compile/testsoftfloat ${D}/${TARGET_TEST_DIR}
    install ${S}/TestFloat-${PV}/build/Linux-Cross-Compile/timesoftfloat ${D}/${TARGET_TEST_DIR}
}
